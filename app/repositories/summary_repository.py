...
class SummaryRepository:
    ...
    def load_summary(self, conversation_id: str, user_id: str) -> SummaryDict:
        """
    ...
    def save_summary(self, conversation_id: str, summary_content: str) -> bool:
        """
    ...
    def mark_messages_as_summarized(self, message_ids: List[str]) -> bool:
        """
