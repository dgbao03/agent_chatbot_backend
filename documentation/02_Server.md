...
- **Alembic does not create the database** — the database itself must exist before running any migration commands; only tables and schema objects are managed by Alembic
